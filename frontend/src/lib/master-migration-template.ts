...
export function downloadMasterMigrationTemplate(config: MasterMigrationTemplateConfig = { includeSampleData: true }) {
  ...
  const productsData = [
    ...
    },
    {
      ...
      "TaxRate*": 18,
      "CessRate": 0,
      "PurchasePrice": 98000.00,
      "RetailRate*": 124999.00,
      "WholesaleRate": 118000.00,
      "MRP*": 134999.00,
      "MinimumStockAlert": 3,
      "ReorderQuantity": 10,
      "OpeningStock": 8,
      "BatchNumber": "352891104829102",
      "ExpiryDate": "",
      "RackLocation": "Display Vault 1",
      "Description": "Titanium Gray 12GB RAM Flagship AI Smartphone"
    },
    {
      ...
      "RetailRate*": 1199.00,
      "WholesaleRate": 999.00,
      "MRP*": 1499.00,
      "MinimumStockAlert": 10,
      "ReorderQuantity": 25,
      "OpeningStock": 35,
      "BatchNumber": "SN-BT2026-881",
      "ExpiryDate": "",
      "RackLocation": "Shelf E-2",
      "Description": "42H Playtime Beast Mode Wireless Earbuds"
    }
  ];
