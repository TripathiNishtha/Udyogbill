...
export default function UniversalHrmSuitePage() {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6">
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-slate-900 via-orange-950 to-slate-900 text-white p-6 rounded-2xl shadow-xl border border-orange-900/50">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 bg-orange-50 dark:bg-orange-950/50 rounded-xl text-orange-600">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-4 py-2 text-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
              </div>
            </div>
          </div>
                ...
                {leaveApps.map((leave) => (
                  <tr key={leave.id} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    <td className="py-3 px-4">
                      ...
                      <div className="text-xs font-mono text-orange-600 dark:text-orange-400">{leave.employeeCode}</div>
                    </td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-right">
                      {leave.status === 1 ? (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-orange-600 hover:bg-orange-700 text-white text-xs font-semibold shadow-sm transition-all"
                        >
                          Review
                        </button>
                      ) : (
                ...
                {attendanceLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    <td className="py-3 px-4">
                      ...
                      <div className="text-xs font-mono text-orange-600 dark:text-orange-400">{log.employeeCode}</div>
                    </td>
                    <td className="py-3 px-4">
                ...
                {expenseClaims.map((claim) => (
                  <tr key={claim.id} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    <td className="py-3 px-4">
                      ...
                      <div className="text-xs font-mono text-orange-600 dark:text-orange-400">{claim.employeeCode}</div>
                    </td>
                    <td className="py-3 px-4 text-xs text-slate-600 dark:text-slate-400">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold shadow-md shadow-orange-600/20 transition-all disabled:opacity-50"
                >
                  <DollarSign className="w-4 h-4" />
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full text-sm p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-sm p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold"
              />
            </div>
