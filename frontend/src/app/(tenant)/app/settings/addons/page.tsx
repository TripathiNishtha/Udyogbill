  ...
  return (
    <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-2">
        ...
        <Link
          ...
          className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold border border-slate-200 dark:border-slate-700 shadow-xs transition-all self-start sm:self-auto"
        >
      ...
      {actionMsg && (
        ...
        >
          {actionMsg.type === "success" ? <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" /> : <AlertCircle className="w-4 h-4 text-rose-600 dark:text-rose-400" />}
          <span>{actionMsg.text}</span>
        </div>
      )}

      {/* Primary Card: Active Core Subscription & Industry Pack */}
      <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-50/70 via-white to-slate-50/80 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 border border-emerald-200 dark:border-emerald-500/30 shadow-sm dark:shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-slate-800 pt-4 lg:pt-0 lg:pl-6 shrink-0">
            <div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Staff User Capacity</div>
              ...
              <div className="w-36 bg-slate-200 dark:bg-slate-800 rounded-full h-1.5 mt-2 overflow-hidden">
                <div
        ...
        <div className="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs text-slate-700 dark:text-slate-300 relative z-10">
      ...
      <div>
        <div className="mb-4">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white tracking-tight">Available Expansion Add-Ons</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 flex flex-col justify-between space-y-5 hover:border-slate-300 dark:hover:border-slate-700 shadow-xs transition-all">
            <div className="space-y-4">
              ...
              <div>
                <h4 className="text-base font-bold text-slate-900 dark:text-white">Staff User Add-On Packs</h4>
              ...
              <div className="space-y-2.5 pt-2">
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                  <div>
                    <div className="text-xs font-semibold text-slate-900 dark:text-white">+1 Single Extra User</div>
                ...
                <div className="p-3 rounded-xl bg-sky-50/50 dark:bg-slate-900 border border-sky-200 dark:border-sky-500/30 flex items-center justify-between relative overflow-hidden">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-slate-900 dark:text-white">+5 Users Pack (Bulk Value)</div>
          ...
          <div className={`p-6 rounded-2xl bg-white dark:bg-slate-950/60 border flex flex-col justify-between space-y-5 transition-all shadow-xs ${
            isAiActive ? "border-purple-300 dark:border-purple-500/50 shadow-md shadow-purple-500/10" : "border-slate-200 dark:border-slate-800 hover:border-purple-200 dark:hover:border-slate-700"
          }`}>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {isAiActive ? (
                  <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-300 dark:bg-emerald-500/20 dark:text-emerald-300 dark:border-emerald-500/30 flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3 text-emerald-600 dark:text-emerald-400" /> Active & Enrolled
                  </span>
                ) : (
                  <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-purple-50 text-purple-700 border border-purple-200 dark:bg-purple-500/10 dark:text-purple-400 dark:border-purple-500/20">
                    AI Automation
                  </span>
                )}
              </div>
              ...
              <div>
                <h4 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 text-[9px] font-bold rounded bg-purple-100 text-purple-700 border border-purple-200 dark:bg-purple-500/20 dark:text-purple-300 dark:border-purple-500/30">PRO</span>
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
              ...
              {isAiActive ? (
                <div className="p-3.5 rounded-xl bg-purple-50/70 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-500/20 space-y-2">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-600 dark:text-slate-400">Monthly Scan Quota:</span>
                    <span className="font-bold text-purple-700 dark:text-purple-300">{scansRemaining} / {scansLimit} remaining</span>
                  </div>
                  <div className="w-full bg-purple-100 dark:bg-slate-900 rounded-full h-1.5 overflow-hidden">
                    <div
                      className="bg-purple-600 dark:bg-purple-500 h-1.5 rounded-full"
                      style={{ width: `${Math.max(5, (scansRemaining / scansLimit) * 100)}%` }}
                    />
                  </div>
                  <div className="text-[10px] text-slate-500 dark:text-slate-400 text-right">Quota resets monthly</div>
                </div>
              ) : (
                <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                  <div>
                    <div className="text-xs font-semibold text-slate-900 dark:text-white">500 Invoices / Month Quota</div>
                    <div className="text-[11px] text-slate-500 dark:text-slate-400">₹{aiPrice}/year + {gstRate}% GST</div>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-bold text-purple-600 dark:text-purple-400">₹{(aiPrice * (1 + gstRate / 100)).toFixed(0)}</span>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 block">incl. GST/yr</span>
                  </div>
                </div>
              )}
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80">
              {isAiActive ? (
                <Link
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-semibold flex items-center justify-center gap-2 transition-all shadow-sm"
                >
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md shadow-purple-600/20"
                >
          ...
          <div
            className={`p-6 rounded-2xl bg-white dark:bg-slate-950/60 border flex flex-col justify-between space-y-5 transition-all shadow-xs ${
              isSfaActive
                ? "border-teal-300 dark:border-teal-500/50 shadow-md shadow-teal-500/10"
                : isPharmaTenant
                ? "border-teal-200 dark:border-teal-500/30 hover:border-teal-300 dark:hover:border-teal-500/50"
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {isSfaActive ? (
                  <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-300 dark:bg-emerald-500/20 dark:text-emerald-300 dark:border-emerald-500/30 flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3 text-emerald-600 dark:text-emerald-400" /> Active & Subscribed
                  </span>
                ) : isPharmaTenant ? (
                  <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-teal-50 text-teal-700 border border-teal-200 dark:bg-teal-500/10 dark:text-teal-300 dark:border-teal-500/20">
                    Pharma Add-on (Optional)
                  </span>
                ) : (
                  <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-600 border border-slate-200 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700 flex items-center gap-1">
              ...
              <div>
                <h4 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 text-[9px] font-bold rounded bg-teal-100 text-teal-700 border border-teal-200 dark:bg-teal-500/20 dark:text-teal-300 dark:border-teal-500/30">ADD-ON</span>
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
              ...
              {isSfaActive ? (
                <div className="p-3.5 rounded-xl bg-teal-50/70 dark:bg-teal-950/30 border border-teal-200 dark:border-teal-500/20 space-y-2.5">
                  <div className="flex justify-between items-center text-xs">
                  ...
                  <div className="w-full bg-teal-100 dark:bg-slate-900 rounded-full h-1.5 overflow-hidden">
                    <div
                  ...
                  <div className="flex justify-between items-center text-xs pt-2 border-t border-teal-200 dark:border-teal-900/50">
                    <span className="text-slate-700 dark:text-slate-300 flex items-center gap-1.5 font-medium">
                ...
                <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
                  <div className="flex justify-between items-center">
                    <div className="text-xs font-semibold text-slate-900 dark:text-white">15 MR + 5 Manager Seats</div>
                    <span className="text-xs font-bold text-teal-600 dark:text-teal-400">Included in Add-on</span>
                  </div>
              ...
              {isSfaActive ? (
                <>
                  <Link
                    ...
                    className="w-full py-2.5 px-4 rounded-xl bg-teal-600 hover:bg-teal-500 text-white text-xs font-semibold flex items-center justify-center gap-2 transition-all shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-1.5 px-3 rounded-lg text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 hover:bg-rose-50 dark:hover:bg-rose-500/10 text-[11px] font-medium transition-all cursor-pointer text-center"
                  >
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-teal-600 hover:bg-teal-500 disabled:opacity-50 text-white text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md shadow-teal-600/20"
                >
                  <Activity className="w-3.5 h-3.5" />
                  <span>{activatingSfa ? "Activating SFA Add-on..." : "Subscribe to Pharma SFA Add-on"}</span>
                </button>
              ) : (
                <div className="w-full py-2.5 px-4 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-500 text-xs font-medium flex items-center justify-center gap-2">
      ...
      <div className="p-4 rounded-xl bg-emerald-50/60 dark:bg-slate-900/60 border border-emerald-200 dark:border-slate-800 flex items-start gap-3">
        <ShieldCheck className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
        <div className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          <strong className="text-slate-900 dark:text-slate-200">UdyogBill Transparent Commercial Policy: </strong>
          Industry packs (Pharma, FMCG, Electronics, Garments, Hardware, Service Sector, Retail) are{" "}
          <span className="text-emerald-700 dark:text-emerald-400 font-semibold">100% included in your core plan</span>{" "}
          and are never charged as separate monthly add-ons. You only pay for additional staff capacity or optional AI document scanning.
        </div>
      </div>
    </div>
  );
