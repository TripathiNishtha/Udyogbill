...
export default function DataMigrationHubPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-50/90 via-slate-50 to-indigo-50/70 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 border border-emerald-200 dark:border-slate-800 rounded-2xl p-6 relative overflow-hidden shadow-xs text-slate-900 dark:text-white">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <Link
              ...
              className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5 shadow-md shadow-indigo-900/20"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl space-y-3 shadow-xs">
              ...
              <button
                ...
                className="w-full py-2 bg-indigo-50 hover:bg-indigo-600 text-indigo-700 hover:text-white border border-indigo-200 dark:bg-indigo-600/20 dark:hover:bg-indigo-600 dark:text-indigo-300 dark:hover:text-white dark:border-indigo-500/30 rounded-xl text-xs font-bold flex items-center justify-center space-x-2 transition cursor-pointer"
              >
                    ...
                    {partyRows.map((row) => (
                      <tr key={row.rowId} className="hover:bg-slate-50 dark:hover:bg-slate-900/50">
                        ...
                        <td className="p-3 text-right font-mono font-bold">
                          {row.openingBal > 0 ? (
                            <span className={row.balanceType === 1 ? "text-blue-600 dark:text-blue-400" : "text-rose-600 dark:text-rose-400"}>
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60 bg-white dark:bg-slate-950">
                    {productRows.map((row) => (
                      <tr key={row.rowId} className="hover:bg-slate-50 dark:hover:bg-slate-900/50">
                        ...
                        <td className="p-3 text-right font-mono text-indigo-600 dark:text-indigo-400 font-bold">₹{(row.wholesaleRate || row.sellingPrice).toFixed(2)}</td>
                        <td className="p-3 font-mono text-xs">
                          <span className="text-indigo-600 dark:text-indigo-400">{row.batch}</span>
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800 bg-white dark:bg-slate-950">
                {migrationLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-slate-50 dark:hover:bg-slate-900/50">
                    <td className="p-3 font-mono font-bold text-indigo-600 dark:text-indigo-400">{log.id}</td>
