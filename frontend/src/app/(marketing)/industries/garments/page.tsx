...
export const metadata: Metadata = {
  title: "Garment Shop Billing Software India | Size Color Matrix | UdyogBill",
  description: "Garment shops aur wholesalers ke liye billing software. Size-color matrix, style variants, season management, fast billing. India ka best garment billing software.",
  alternates: {
...
export default function IndustryPage() {
  const features = [{icon:'📐',title:'Size-Color Matrix',desc:'S, M, L, XL — har size ka, har color ka stock alag-alag dikhta hai. No confusion.'},{icon:'🎨',title:'Style Variants',desc:'Ek style ke multiple variants manage karo. Billing mein variant auto-select.'},{icon:'🏷️',title:'Barcode Billing',desc:'Barcode scan se fast billing. Counter pe kaafi time bachta hai.'},{icon:'📅',title:'Season Management',desc:'Summer, winter collection alag-alag manage karo. Season end pe clearance reports.'},{icon:'🔄',title:'Stock Transfers',desc:'Ek branch ya godown se doosre mein stock transfer karo easily.'},{icon:'📊',title:'Sales Analysis',desc:'Kaun sa style sabse zyada bika — item-wise analysis ek click mein.'}];
  return (
    <>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">Garment shops aur wholesalers ke liye billing software. Size-color matrix, style variants, season management, fast billing. India ka best garment billing software.</p>
            ...
            <div className="rounded-2xl p-6" style={{background:"linear-gradient(135deg,#16a34a15,#f9731615)"}}>
              ...
              <div className="space-y-3">
                {[["Size-color ka stock track karna confusing tha","Size-color matrix mein exact stock dikhta hai"],["Style variants ke saath billing mein galtiyan hoti thi","Style aur variant wise billing — zero error"],["Season stock clearance ka hisaab nahi rehta tha","Season-wise reports aur clearance management"]].map(([p,s])=>(
