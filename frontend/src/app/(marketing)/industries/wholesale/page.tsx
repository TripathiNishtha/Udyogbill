...
export const metadata: Metadata = {
  title: "Wholesale Business Billing Software India | Party Ledger | UdyogBill",
  description: "Wholesale traders ke liye GST billing software. Bulk billing, party management, credit limit, outstanding reports. India ka trusted wholesale billing solution.",
  alternates: {
...
export default function IndustryPage() {
  const features = [{icon:'💰',title:'Party Ledger',desc:'Har customer aur supplier ka poora hisaab. Opening balance, transactions, closing balance.'},{icon:'🚫',title:'Credit Limit',desc:'Har party ka credit limit set karo. Limit se zyada bill nahi banta — auto block.'},{icon:'📋',title:'Bulk Billing',desc:'Ek customer ke liye ek saath kaafi items bill karo. Fast aur error-free.'},{icon:'📊',title:'Outstanding Reports',desc:'Kitne dino se kitna outstanding hai — ageing report ek click mein.'},{icon:'🤝',title:'Salesman Tracking',desc:'Har salesman ki party list aur collection — performance track karo.'},{icon:'📄',title:'Challan & Gate Pass',desc:'Delivery challan, gate pass aur invoice — sab connected.'}];
  return (
    <>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">Wholesale traders ke liye GST billing software. Bulk billing, party management, credit limit, outstanding reports. India ka trusted wholesale billing solution.</p>
            ...
            <div className="rounded-2xl p-6" style={{background:"linear-gradient(135deg,#16a34a15,#f9731615)"}}>
              ...
              <div className="space-y-3">
                {[["Kaun sa customer kitna baaki hai pata nahi tha","Party ledger mein har outstanding clearly dikhta hai"],["Credit limit se zyada credit de diya jaata tha","Credit limit set karo — system block karta hai"],["Bulk billing mein time bahut lagta tha","Bulk billing fast aur error-free"]].map(([p,s])=>(
