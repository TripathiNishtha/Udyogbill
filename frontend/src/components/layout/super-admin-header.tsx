    ...
    <header className="h-14 bg-white border-b border-slate-200 px-3 sm:px-6 flex items-center justify-between z-20 shrink-0 shadow-xs">
      ...
      <div className="flex items-center space-x-2">
        {onOpenMobile && (
          <button
            ...
            className="lg:hidden p-1.5 -ml-1 rounded-xl text-slate-700 hover:text-orange-600 hover:bg-slate-100 border border-slate-200 transition-colors cursor-pointer"
            title="Open Navigation Menu"
          >
            <Menu className="w-5 h-5" />
          </button>
        )}
        <div className="flex items-center space-x-1.5 px-2.5 py-1 rounded-lg bg-orange-50 border border-orange-100 text-orange-700 text-xs font-bold">
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        <div className="hidden md:flex items-center space-x-2.5 pl-2 border-l border-slate-200">
          <div className="w-8 h-8 rounded-full bg-orange-600 text-white flex items-center justify-center text-xs font-bold shadow-xs">
            SA
          </div>
