...
ALTER TABLE IF EXISTS ""AddOns"" ADD COLUMN IF NOT EXISTS ""IsHidden"" boolean NOT NULL DEFAULT FALSE;
ALTER TABLE IF EXISTS ""addons"" ADD COLUMN IF NOT EXISTS ""IsHidden"" boolean NOT NULL DEFAULT FALSE;
ALTER TABLE IF EXISTS ""add_ons"" ADD COLUMN IF NOT EXISTS ""IsHidden"" boolean NOT NULL DEFAULT FALSE;
ALTER TABLE IF EXISTS ""Plans"" ADD COLUMN IF NOT EXISTS ""IsHidden"" boolean NOT NULL DEFAULT FALSE;
ALTER TABLE IF EXISTS ""plans"" ADD COLUMN IF NOT EXISTS ""IsHidden"" boolean NOT NULL DEFAULT FALSE;
