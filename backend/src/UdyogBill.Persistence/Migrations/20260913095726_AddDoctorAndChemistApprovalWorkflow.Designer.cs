...
namespace UdyogBill.Persistence.Migrations
{
    ...
    [Migration("20260913095726_AddDoctorAndChemistApprovalWorkflow")]
    partial class AddDoctorAndChemistApprovalWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmAttendanceLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AssociatedDcrId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsLateMark")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsPunchInGeofenceVerified")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("PunchInTimeUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("PunchOutTimeUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("WorkModeAtPunch")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("HrmAttendanceLogs");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmEmployeeProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DefaultStationType")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("OfficeGeofenceRadiusMeters")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("OfficeWifiSsid")
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("ReportingManagerUserId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("ResignationDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("SfaDivisionId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("SfaTerritoryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReportingManagerUserId");

                    b.HasIndex("UserId");

                    b.ToTable("HrmEmployeeProfiles");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmExpenseClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("ClaimedDistanceKm")
                        .HasColumnType("numeric");
                    ...
                    b.Property<Guid?>("SfaDailyCallReportId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HrmExpenseClaims");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmLeaveApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HrmLeaveApplications");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmLeaveBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("PendingApprovalDays")
                        .HasColumnType("numeric");

                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");

                    b.Property<decimal>("TotalAllocatedDays")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("HrmLeaveBalances");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmLeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("HrmLeaveTypes");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmPayrollCycle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("TotalEsicContribution")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalGrossPayout")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalNetPayout")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalPfContribution")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("HrmPayrollCycles");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmPayslip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("ConveyanceEarned")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("EmployeeEsicDeduction")
                        .HasColumnType("numeric");

                    b.Property<decimal>("EmployeePfDeduction")
                        .HasColumnType("numeric");

                    b.Property<Guid>("EmployeeProfileId")
                        .HasColumnType("uuid");

                    b.Property<decimal>("HraEarned")
                        .HasColumnType("numeric");
                    ...
                    b.Property<string>("PaymentReferenceTransactionId")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal>("ReimbursedExpensesEarned")
                        .HasColumnType("numeric");

                    b.Property<decimal>("SalaryAdvanceRecovery")
                        .HasColumnType("numeric");

                    b.Property<decimal>("SalesIncentiveEarned")
                        .HasColumnType("numeric");

                    b.Property<decimal>("SpecialAllowanceEarned")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("HrmPayslips");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmSalaryStructure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("CurrentOutstandingAdvance")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("EstimatedMonthlyTds")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool>("IsProfessionalTaxApplicable")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("HrmSalaryStructures");
                });

            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmStationPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal>("BikeRatePerKm")
                        .HasColumnType("numeric");

                    b.Property<decimal>("CarRatePerKm")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("HotelStayMaxLimit")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool>("RequiresReceiptAboveAmount")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.Pharma.DoctorPrescriber", b =>
                {
                    ...
                    b.Property<int>("DeleteApprovalLevel")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmAttendanceLog", b =>
                {
                    b.HasOne("UdyogBill.Domain.Entities.HRM.HrmEmployeeProfile", "EmployeeProfile")
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmEmployeeProfile", b =>
                {
                    b.HasOne("UdyogBill.Domain.Entities.Identity.User", "ReportingManagerUser")
                        .WithMany()
                        .HasForeignKey("ReportingManagerUserId");
                    ...
                    b.Navigation("ReportingManagerUser");
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmLeaveApplication", b =>
                {
                    ...
                    b.HasOne("UdyogBill.Domain.Entities.HRM.HrmLeaveType", "LeaveType")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UdyogBill.Domain.Entities.Identity.User", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmPayslip", b =>
                {
                    ...
                    b.HasOne("UdyogBill.Domain.Entities.HRM.HrmPayrollCycle", "PayrollCycle")
                        .WithMany()
            ...
            modelBuilder.Entity("UdyogBill.Domain.Entities.HRM.HrmSalaryStructure", b =>
                {
                    b.HasOne("UdyogBill.Domain.Entities.HRM.HrmEmployeeProfile", "EmployeeProfile")
                        ...
                        .HasForeignKey("UdyogBill.Domain.Entities.HRM.HrmSalaryStructure", "EmployeeProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
